...
public class SelectionWindow extends JDialog {
	...
	public SelectionWindow(InputWindow dialog, Salesman salesman, String fileTypeFlag) {
		inputDialog = dialog;
	...
	protected void okButtonPressed(ActionEvent evt) {
		...
		ResultWindow rs = new ResultWindow(this,selectedSalesman, totalSales, totalItems, shirtSales, skirtSales, trousersSales, coatsSales, commission);
	 	rs.setVisible(true);
