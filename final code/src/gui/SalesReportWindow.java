...
public class SalesReportWindow extends JDialog {
	...
	private ReceiptSelectionDialog selectionWindow;
	...
	public SalesReportWindow(final ReceiptSelectionDialog sw, Salesman salesman,double tSales,int tItems,
	...
	private void initialise(){
		...
		resultWindowPanel.setLayout(null);
		{
			...
			xmlReportButton.setBounds(436, 215, 163, 81);
		...
		}
		{
			...
			htmlReportButton.setBounds(436, 123, 163, 81);
	...
	private void outputTXTButtonPressed(ActionEvent evt) {
        ...
        TXTReportGenerator makeTXTFile = new TXTReportGenerator(selectedSalesman);
	...
	private void outputXMLButtonPressed(ActionEvent evt) {
        ...
        XMLReportGenerator makeXMLFile = new XMLReportGenerator(selectedSalesman);
	...
	private void outputHTMLButtonPressed(ActionEvent evt) {
        ...
        HTMLReportGenerator makeHTMLFile = new HTMLReportGenerator(selectedSalesman);
